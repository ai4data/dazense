"""PostHog analytics tracking for dazense CLI.

This module provides analytics tracking to help improve dazense.
...
DISTINCT_ID_FILE = Path.home() / ".dazense" / "distinct_id"
...
def track_command(command_name: str) -> Callable[[F], F]:
    ...
    - Persistent distinct_id (stored in ~/.dazense/distinct_id)
