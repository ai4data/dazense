...
class GitContextProvider(ContextProvider):
    ...
    def init(self) -> None:
        ...
        Raises:
            ...
            ValueError: If cloned repo doesn't contain dazense_config.yaml.
        """
        ...
        if not self.validate():
            raise ValueError(
                "dazense_config.yaml not found in cloned repository.\n"
                "Ensure the repository contains a valid dazense project at its root."
            )
