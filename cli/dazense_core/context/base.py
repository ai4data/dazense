...
class ContextProvider(ABC):
    ...
    A context provider is responsible for loading the dazense project context
    ...
    def validate(self) -> bool:
        ...
        Returns:
            True if dazense_config.yaml exists in target path.
        """
        config_file = self.target_path / "dazense_config.yaml"
