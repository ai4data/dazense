...
# Path to the default templates shipped with dazense
...
class TemplateEngine:
    ...
    2. Default templates shipped with dazense

    This allows users to customize output by creating a `templates/` folder
    in their dazense project and adding templates with the same names as the defaults.
    ...
    def __init__(self, project_path: Path | None = None):
        ...
        Args:
            project_path: Path to the dazense project root. If provided,
