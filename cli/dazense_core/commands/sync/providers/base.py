...
class SyncProvider(ABC):
    ...
    (e.g., repositories, databases) from the dazense configuration to local files.
    """
    ...
    def sync(self, items: list[Any], output_path: Path, project_path: Path | None = None) -> SyncResult:
        ...
        Args:
                ...
                project_path: Path to the dazense project root (for template resolution)
    ...
    def pre_sync(self, config: DazenseConfig, output_path: Path) -> None:
        ...
        Args:
            config: The loaded dazense configuration.
