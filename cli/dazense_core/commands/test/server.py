...
<head>
    ...
    <title>dazense Test Results</title>
        ...
        function App() {
            ...
            return (
                <div className="container">
                    <header>
                        <h1>dazense <span>Test Results</span></h1>
...
def server(
    ...
    Examples:
        dazense test server
        dazense test server --port 9000
        dazense test server --no-open
    """
    ...
    if not outputs_dir.exists():
        ...
        UI.info("Run 'dazense test' first to generate test results.")
        return
    ...
    UI.info("\n📊 Starting dazense test results server...\n")
