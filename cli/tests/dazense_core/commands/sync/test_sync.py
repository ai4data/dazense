...
from dazense_core.commands.sync.providers import ProviderSelection, SyncProvider, SyncResult
...
class TestSyncCommand:
    def test_sync_exits_when_no_config_found(self, tmp_path: Path, monkeypatch):
        ...
        with patch("dazense_core.ui.create_console", return_value=mock_console):
            ...
            mock_console.print.assert_any_call(
                "[bold red]✗[/bold red] No dazense_config.yaml found in current directory"
            )
    ...
    def test_sync_runs_providers_when_config_exists(self, create_config):
        ...
        with patch("dazense_core.commands.sync.console"):
    ...
    def test_sync_prints_nothing_to_sync_when_no_results(self, create_config):
        ...
        with patch("dazense_core.commands.sync.console") as mock_console:
            sync(_providers=[selection])
