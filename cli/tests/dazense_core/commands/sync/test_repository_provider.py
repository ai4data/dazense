...
from dazense_core.commands.sync.providers.repositories.provider import (
...
class TestRepositorySyncProvider:
    ...
    def test_get_items_returns_repos_from_config(self):
        provider = RepositorySyncProvider()
        mock_config = MagicMock(spec=DazenseConfig)
        mock_config.repos = [
    ...
    @patch("dazense_core.commands.sync.providers.repositories.provider.clone_or_pull_repo")
    @patch("dazense_core.commands.sync.providers.repositories.provider.console")
...
class TestCloneOrPullRepo:
    @patch("dazense_core.commands.sync.providers.repositories.provider.subprocess.run")
    @patch("dazense_core.commands.sync.providers.repositories.provider.console")
