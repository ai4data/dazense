...
from dazense_core.config.databases.bigquery import BigQueryConfig
...
def temp_datasets():
    ...
    public_dataset_id = "dazense_integration_tests_public"
    another_dataset_id = "dazense_integration_tests_another"
    ...
    try:
        ...
        # Clean up any old dazense_unit_tests_ datasets from failed runs
        for dataset in bq_client.list_datasets():
            if dataset.dataset_id.startswith("dazense_unit_tests_"):
