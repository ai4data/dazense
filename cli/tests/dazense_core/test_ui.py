...
class TestAskText:
    ...
    @patch("dazense_core.ui.questionary.text")
    ...
    @patch("dazense_core.ui.questionary.password")
...
class TestAskConfirm:
    ...
    @patch("dazense_core.ui.questionary.confirm")
...
class TestAskSelect:
    ...
    @patch("dazense_core.ui.questionary.select")
